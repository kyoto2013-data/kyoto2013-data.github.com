# 俺のゼニはどこ行った for 横浜(wheredoesmymoney.orgの横浜バージョン)をもとに作成した京都市バージョンです．

http://kyoto2013-data.github.io/kyolib2013-data.github.com/index.html で稼働しているサイトのソースコードです。
...
京都市版は現在　Kyolib2013が製作していますが、ただいま有志を募集中です。
